          ...
          <section className="form-section basic-info-section">
            ...
            {showBasicInfo && (
              <div className="profile-inputs-slide" style={{ animation: "fadeIn 0.3s ease" }}>
                ...
                <label htmlFor="major">Academic Major / Program*</label>
                <select 
                  id="major" 
                  name="major" 
                  value={profile.major || ""} 
                  ...
                  required 
                  style={{ width: "100%", padding: "10px 12px", background: "#1c1914", border: "1px solid rgba(243, 193, 68, 0.3)", borderRadius: "8px", color: "#fff", fontSize: "14px", marginBottom: "16px" }}
                >
