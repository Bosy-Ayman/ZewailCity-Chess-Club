  ...
  const roleSpecificContent = (
    <Fragment>
      <section className="form-section trainer-section">
        ...
        <input type="number" id="chess-score" name="chess-score" min="0" required />
        ...
        <textarea id="trainer-availability" name="trainer-availability" rows="3"></textarea>
        ...
        <input type="text" id="sunday-avail" name="sunday-avail" placeholder="e.g., 2:00 PM - 5:00 PM or Not Available" required />

        <label htmlFor="monday-avail">Monday*</label>
        <input type="text" id="monday-avail" name="monday-avail" placeholder="e.g., 10:00 AM - 1:00 PM or Not Available" required />
        
        <label htmlFor="tuesday-avail">Tuesday*</label>
        <input type="text" id="tuesday-avail" name="tuesday-avail" placeholder="e.g., 2:00 PM - 5:00 PM or Not Available" required />
        
        <label htmlFor="wednesday-avail">Wednesday*</label>
        <input type="text" id="wednesday-avail" name="wednesday-avail" placeholder="e.g., 10:00 AM - 1:00 PM or Not Available" required />
        
        <label htmlFor="thursday-avail">Thursday*</label>
        <input type="text" id="thursday-avail" name="thursday-avail" placeholder="e.g., 2:00 PM - 5:00 PM or Not Available" required />
      </section>
    </Fragment>
  );
